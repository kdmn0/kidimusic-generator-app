  ...
  const showcaseTracks = [
    {
      ...
      genre: 'Heavy Metal',
      prompt: 'Trash metal music with drum, electro guitar and bass guitar',
      url: '/music/metal.mp3',
    ...
    },
    {
      ...
      prompt: 'Retro 80s synthwave, driving synth bass, analog synthesizers, neon streets, nocturnal drive, 110 BPM',
      url: '/music/synth.mp3',
    ...
    },
    {
      ...
      genre: 'Upbeat Pop',
      prompt: 'Catchy upbeat pop, acoustic guitar, bright piano chords, energetic drums, happy summer mood, 120 BPM',
      url: '/music/pop.mp3',
    ...
    },
    {
      ...
      genre: 'Lo-Fi Hip-Hop',
      prompt: 'Smooth lo-fi hip-hop with jazz chords, vinyl crackling, and chill midnight atmosphere',
      url: '/music/lofi.mp3',
